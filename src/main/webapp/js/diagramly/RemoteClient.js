...
// Extends DrawioClient
     ...
     */
    RemoteClient.prototype.updateUser = function(success, error, failOnAuth)
    {
     ...
     * Authorizes the client, gets the userId and calls <open>.
     */
    RemoteClient.prototype.createUser = function(userInfo)
    {
     ...
     * Authorizes the client, gets the userId and calls <open>.
     */
    RemoteClient.prototype.authenticate = function(success, error)
    {
    ...
    RemoteClient.prototype.authenticateStep2 = function(state, success, error)
    {
     ...
     * Authorizes the client, gets the userId and calls <open>.
     */
    RemoteClient.prototype.showAuthorizeDialog = function(retryFn, cancelFn)
    {
     ...
     * Checks if the client is authorized and calls the next step.
     */
    RemoteClient.prototype.getSha = function(org, repo, path, ref, success, error, returnNotFound)
    {
     ...
     */
    RemoteClient.prototype.createGitHubFile = function(org, repo, ref, data, asLibrary)
    {
     ...
     * @param {number} dy Y-coordinate of the translation.
     */
    RemoteClient.prototype.insertLibrary = function(filename, data, success, error, folderId)
    {
     ...
     *
     */
    RemoteClient.prototype.writeFile = function(org, repo, ref, path, message, data, sha, success, error)
    {
     ...
     * @param {number} dy Y-coordinate of the translation.
     */
    RemoteClient.prototype.checkExists = function(path, askReplace, fn)
    {
        var tokens = path.split('/');
        var org = tokens[0];
        var repo = tokens[1];
     ...
     * Checks if the client is authorized and calls the next step.
     */
    RemoteClient.prototype.pickLibrary = function(fn)
    {
        this.pickFile(fn);
    };
     ...
     * Checks if the client is authorized and calls the next step.
     */
    RemoteClient.prototype.pickFolder = function(fn)
    {
     ...
     * Checks if the client is authorized and calls the next step.
     */
    RemoteClient.prototype.pickFile = function(fn)
    {
     ...
     *
     */
    RemoteClient.prototype.showGitHubDialog = function(showFiles, fn, hideNoFilesError)
    {
        var org = null;
        var repo = null;
        var ref = null;
     ...
     * Checks if the client is authorized and calls the next step.
     */
    RemoteClient.prototype.logout = function()
    {
